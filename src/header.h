...
void Input(int player, int *current_x, char *current_y,int *to_x, char *to_y, char board[8][8][5]);
...
void FixBoard(int current_x, int current_y,char board[8][8][5]);
...
void Checkpassant(int to_x, int to_y, int *passant_x, int *passant_y, int player, int *flagpassant,char board[8][8][5]);
void Dopassant(int current_x, char current_y ,int to_x, int to_y, int player, int moves,char *flag, int *count_deadBlack, int *count_deadWhite,char kill_black[16][5],
    int killed_black_at[16], char kill_white[16][5], int killed_white_at[16],char board[8][8][5], int *passant_x, int *passant_y, int passant_counter[8], int *passantIndex);
...
void DoCastling(int player, int current_x, int current_y, char board[8][8][5]);
