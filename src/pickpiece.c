...
void PickPiece(int player, int current_x, int current_y,
        ...
        paw_move(player,  current_x,  current_y,  to_x,  to_y,  board,  kill_white, kill_black,
                ...
                flagpassant,  passant_x,  passant_y,  passant_counter,  passantIndex,  promotion_white_at,  promotion_white_type, 
                WPromotionIndex, promotion_black_at,  promotion_black_type,  BPromotionIndex, moves_draw, flagsave, promotion_index, promotion_hist);
