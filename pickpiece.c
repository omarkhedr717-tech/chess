...
void PickPiece(int player, int current_x, int current_y,
                ...
                int moves, int killed_white_at[16], int killed_black_at[16], int *flagpassant, int possion_white_at[8], int possion_black_at[8], int *passant_x, char *passant_y) {
        ...
        if ((strcmp(board[current_x][current_y], "♛")==0) || (strcmp(board[current_x][current_y], "♕")==0))
        queen_move(player, current_x, current_y, to_x, to_y, board, kill_white, kill_black, count_deadWhite,count_deadBlack,flag, moves, killed_white_at, killed_black_at);
        ...
        if ((strcmp(board[current_x][current_y], "♜")==0) || (strcmp(board[current_x][current_y], "♖")==0))
            rook_move(player, current_x, current_y, to_x, to_y, board, kill_white, kill_black, count_deadWhite, count_deadBlack, flag, moves, killed_white_at, killed_black_at);

        if ((strcmp(board[current_x][current_y], "♞")==0) || (strcmp(board[current_x][current_y], "♘")==0))
        knight_move(player, current_x, current_y, to_x, to_y, board, kill_white, kill_black, count_deadWhite,count_deadBlack,flag, moves, killed_white_at, killed_black_at);
    }